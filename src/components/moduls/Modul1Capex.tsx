        ...
        <div className="p-5 flex flex-col gap-5">
          ...
          <Card title="İnşaat & Dekorasyon">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <InputField label="Ses ve Kamera Sistemi Bedeli" value={girdi.sesSistemi} onChange={v => set('sesSistemi', v)} />
          ...
          <Card title="Mutfak ve Servis Ekipmanları">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <InputField label="Diğer Servis Ekipmanları" value={girdi.mutfakDiger} onChange={v => set('mutfakDiger', v)} />
            </div>
