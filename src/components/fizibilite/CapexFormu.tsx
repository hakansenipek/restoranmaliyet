...
const MIMARI_LABELS: Record<keyof CapexMimari, string> = {
  ...
  itfaiyeProjesi: 'İtfaiye Projesi',
  diger: 'Diğer',
};

const MUTFAK_LABELS: Record<keyof CapexMutfak, string> = {
  paslanmazMalzeme: 'Paslanmaz Malzeme Grubu',
  pisiriciGrup: 'Pişirici Grubu',
  buzdolabiVeBuzMakine: 'Buzdolapları ve Buz Makinesi',
  kahveMakinesi: 'Kahve Makinesi',
  ufakAletler: 'Ufak Mutfak Aletleri',
  catalkasikBicak: 'Çatal, Bıçak, Kaşık',
  bardak: 'Bardak',
  tabaklar: 'Tabaklar',
  diger: 'Diğer',
};
