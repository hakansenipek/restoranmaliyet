...
export async function excelIndir(form: FormDurumu, sonuc: HesaplamaSonucu) {
  ...
  const capexData = [
    ...
    [`  Alan: ${form.capex.m2} m² × ${form.capex.m2BirimMaliyet.toLocaleString('tr-TR')} ₺/m²`, ''],
    ['Mutfak Ekipmanları', capex.mutfakEkipmanlari],
    ['  Paslanmaz Grup', form.capex.paslanmazGrup],
    ['  Pişirici Grup', form.capex.pisiriciGrup],
    ['  Soğutma', form.capex.sogutma],
    ['  Kahve Makinesi', form.capex.kahveMakinesi],
    ['  Ufak Aletler', form.capex.ufakAletler],
    ...
    ['  Konsept Tasarım', form.capex.konseptTasarim],
    ['  Belediye Ruhsat Projesi', form.capex.belediyeRuhsatProjesi],
    ['  Doğalgaz/Elektrik Projesi', form.capex.dogalgazElektrikProjesi],
    ['  İtfaiye Projesi', form.capex.itfaiyeProjesi],
    ...
    [`  ${form.capex.kiraDepozitoAy} ay depozito + emlakçı komisyonu`, ''],
