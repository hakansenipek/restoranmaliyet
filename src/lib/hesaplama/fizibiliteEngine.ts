...
export const FIZIBILITE_VARSAYILAN: FizibiliteGirdisi = {
  ...
  gelir: {
    sabah: { aktif: false, kisiBasiHarcama: 0, gunlukKisiSayisi: 0 },
    ogle:  { aktif: false, kisiBasiHarcama: 0, gunlukKisiSayisi: 0 },
    aksam: { aktif: false, kisiBasiHarcama: 0, gunlukKisiSayisi: 0 },
    odemeTipleri: {
      nakitPay: 0.25,
      krediKartiPay: 0.50,
      yemekKartiPay: 0.15,
